...
let g:template['c']['fctv'] = "void ".g:rs."Nom de la fonction".g:re."(".g:rs."Arguments".g:re.") {\<cr>".g:rs."...".g:re."\<cr>}"
let g:template['c']['fcti'] = "int ".g:rs."Nom de la fonction".g:re."(".g:rs."Arguments".g:re.") {\<cr>".g:rs."...".g:re."\<cr>}"
let g:template['c']['fctl'] = "long ".g:rs."Nom de la fonction".g:re."(".g:rs."Arguments".g:re.") {\<cr>".g:rs."...".g:re."\<cr>}"
let g:template['c']['fctd'] = "double ".g:rs."Nom de la fonction".g:re."(".g:rs."Arguments".g:re.") {\<cr>".g:rs."...".g:re."\<cr>}"
let g:template['c']['fctc'] = "char ".g:rs."Nom de la fonction".g:re."(".g:rs."Arguments".g:re.") {\<cr>".g:rs."...".g:re."\<cr>}"
let g:template['c']['fctb'] = "bool ".g:rs."Nom de la fonction".g:re."(".g:rs."Arguments".g:re.") {\<cr>".g:rs."...".g:re."\<cr>}"
let g:template['c']['fct'] = "".g:rs."Type".g:re." " .g:rs."Nom de la fonction".g:re."(".g:rs."Arguments".g:re.") {\<cr>".g:rs."...".g:re."\<cr>}"


let g:template['c']['str'] = "struct ".g:rs."Nom de la structure".g:re." {\<cr>".g:rs."...".g:re."\<cr>};"
