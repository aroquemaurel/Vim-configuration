...
syntax match    adaConditional  "\<pas\>"
...
syntax match    adaStructure	"\<est\ un\ Entier\>"
syntax match    adaStructure	"\<est\ un\ Reel\>"
syntax match    adaStructure	"\<est\ un\ caractere\>"
syntax match    adaStructure	"\<est\ une\ chaine\>"
syntax match    adaStructure	"\<est\ un\ Booleen\>"
