...
"
syntax match adaConditional "\<enregistrement\>"	contains=adaRecord
syntax match adaConditional "\<pointeur\>"	contains=adaRecord
syntax match adaConditional "\<sur\>"	contains=adaRecord
