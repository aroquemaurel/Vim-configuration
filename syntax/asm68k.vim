...
syn keyword asm68kReg	R0 R1 R2 R3 r4 R5 R6 R7 d0 d1 d2 d3 d4 d5 d6 d7
...
syn match asm68kOpcode "\<cmp\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<mov\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<ldr\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<ldrb\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<ldrsb\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<ldrh\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<ldrsh\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<str\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<strl\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<strlo\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<strhs\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<strb\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<strh\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<teq\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<b\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<bgt\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<dld\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<dlg\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<dag\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<add\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<adc\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<sub\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<sbc\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<rbc\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<rsc\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<rsb\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<mul\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<mla\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<thetamull\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<thetamlal\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<and\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<orr\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<eor\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<mvn\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<clz\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<bic\(\.[bwl]\)\=\s"
syn match asm68kOpcode "\<mvn\(\.[bwl]\)\=\s"
...
syn match asm68kPreCond		"\<long\>"
syn match asm68kPreCond		"\<text\>"
syn match asm68kPreCond		"\<bss\>"
syn match asm68kPreCond		"\<align\>"
syn match asm68kPreCond		"\<space\>"
syn match asm68kPreCond		"\<word\>"
syn match asm68kPreCond		"\<equiv\>"
syn match asm68kPreCond		"\<equ\>"
